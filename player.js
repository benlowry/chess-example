((exports) => {
  ...
  function moveAlternativePiece (event) {
    ...
    // 1) captured pieces
    // 2) promoted pieces
    // 3) moving pieces that, within the alternative sequence, have already moved
    // 4) inserting the alternative sequence text
...
;; ((exports) => {
  ...
  exports.findMovingPiece = findMovingPiece
